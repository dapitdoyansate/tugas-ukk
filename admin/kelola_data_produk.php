...
if (isset($_GET['hapus'])) {
    ...
    header("Location: kelola_data_produk.php?status=deleted");
    exit();
}
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .table-header {
            ...
            display: grid;
            grid-template-columns: 80px 250px 200px 120px 150px;
            padding: 15px 20px;
            font-size: 18px;
            font-weight: 600;
            color: #000000;
        ...
        @media (max-width: 1024px) {
            ...
            .table-header, .table-row {
                grid-template-columns: 60px 200px 150px 100px 120px;
                font-size: 14px;
            }
        }
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="dropdown-menu" id="dropdownMenu">
                ...
                <a href="kelola_data_produk.php" class="dropdown-item active">📦 Kelola Data Produk</a>
        ...
        <a href="../auth/logout.php" class="logout-btn">
            <img src="https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-02-24/K1dr2pnb0J.png" alt="Logout">
            Logout
        </a>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            ...
            <div class="table-row">
                ...
                <div class="table-cell"><?php echo $row['stok']; ?></div>
                <div class="table-cell">
                    <a href="edit_produk.php?id=<?php echo $row['id']; ?>" class="btn-action">✏️ Edit</a>
                    <a href="?hapus=<?php echo $row['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Yakin ingin menghapus produk ini?')">🗑️ Hapus</a>
                </div>
            </div>
            <?php endwhile; ?>
        </div>
