...
if (isset($_GET['hapus'])) {
    ...
    header("Location: kelola_data_transaksi.php?status=deleted");
    exit();
}

// Ambil data transaksi dari database dengan join ke tabel users
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .table-header {
            ...
            display: grid;
            grid-template-columns: 80px 150px 200px 200px 150px;
            padding: 15px 20px;
            font-size: 18px;
            font-weight: 600;
            color: #000000;
        ...
        .status-success { background-color: #00d71c; color: #000000; }
        .status-cancelled { background-color: #e02a2a; color: #ffffff; }
        ...
        @media (max-width: 1024px) {
            ...
            .table-header, .table-row {
                grid-template-columns: 60px 120px 150px 150px 120px;
                font-size: 14px;
            }
        }
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="dropdown-menu" id="dropdownMenu">
                ...
                <a href="kelola_data_transaksi.php" class="dropdown-item active">💳 Kelola Data Transaksi</a>
        ...
        <a href="../auth/logout.php" class="logout-btn">
            <img src="https://codia-f2c.s3.us-west-1.amazonaws.com/image/2026-02-24/waOuF6vsjw.png" alt="Logout">
            Logout
        </a>
    </div>
    ...
    <div class="main-content">
        ...
        <?php if(isset($_GET['status'])): ?>
            ...
            <?php elseif($_GET['status'] == 'updated'): ?>
                <div class="alert alert-success">Transaksi berhasil diupdate!</div>
        ...
        <div class="table-container">
            ...
            while($row = mysqli_fetch_assoc($query)): 
                ...
                elseif($row['status'] == 'success') $status_class = 'status-success';
            ...
            <div class="table-row">
                ...
                <div class="table-cell">
                    <a href="edit_transaksi.php?id=<?php echo $row['id']; ?>" class="btn-action">✏️ Edit</a>
                    <a href="?hapus=<?php echo $row['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Yakin ingin menghapus transaksi ini?')">🗑️ Hapus</a>
                </div>
            </div>
            <?php endwhile; ?>
        </div>
